...
#ifndef _SSSP8_Atomic
#define _SSSP8_Atomic

bool ejecutarIteracion_SSSP8_Atomic( 
                       ...
                       unsigned int*  minimoDelBloque_d)
{
    ...
    kernel1_SSSP8_Atomic<<<grid,threads>>>( v_d, a_d, w_d, p_d, f_d, c_d);
...
/////////////////////////////////////// 
void testGraph_SSSP8_Atomic(const unsigned int nv, const unsigned int mem_size_V,
                            ...
                            const unsigned int* reference)
{
    ...
    while(!ultima){
        i++;
        ultima= ejecutarIteracion_SSSP8_Atomic( i, 
    ...
    printf("Runtime for SSSP8_Atomic algorithm is: %.6f ms\n", time);
