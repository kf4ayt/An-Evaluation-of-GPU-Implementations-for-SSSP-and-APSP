...
bool ejecutarIteracion_SSSP3( 
                       ...
                       const unsigned int* v_d, unsigned const int* a_d, unsigned const int* w_d, 
...
/////////////////////////////////////// 
void testGraph_SSSP3(const unsigned int nv, const unsigned int mem_size_V,
                     ...
                     const unsigned int* reference)
{
    ...
    while(!ultima){
        i++;
        ultima= ejecutarIteracion_SSSP3( i, 
    ...
    printf("Runtime for SSSP3 algorithm is: %.6f ms\n", time);
