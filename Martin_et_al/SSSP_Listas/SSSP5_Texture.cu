...
#ifndef _SSSP5_Texture
#define _SSSP5_Texture


//////////////////////////////////////////
bool ejecutarIteracion_SSSP5_tex( 
...
//////////////////////////////////
void testGraph_SSSP5_tex(const unsigned int nv, const unsigned int mem_size_V,
                         ...
                         const unsigned int* reference)
{
    ...
    while(!ultima){
        i++;
        ultima= ejecutarIteracion_SSSP5_tex( i, 
                          grid, threads, 
                          nv, na,
    ...
    printf("Runtime for SSSP5_Texture algorithm is: %.6f ms\n", time);
