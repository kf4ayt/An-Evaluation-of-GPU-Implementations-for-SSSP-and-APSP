...
#ifndef _SSSP6_Texture
#define _SSSP6_Texture


//////////////////////////////////////////
bool ejecutarIteracion_SSSP6_tex( 
                     ...
                     const unsigned int* reference)
{
    ...
    while(!ultima){
        i++;
        ultima= ejecutarIteracion_SSSP6_tex( i, 
                          grid, threads, 
                          nv, na,
